...
screen name_input_dialog(prompt):
    """
    Экран для красивого ввода имени игрока с размытым фоном.
    """
    modal True
    ...
    add Solid((0, 0, 0, 0.6), xysize=(config.screen_width, config.screen_height))
    
    # Центральное окно ввода
    frame:
        xalign 0.5
        yalign 0.5
        xsize 450
